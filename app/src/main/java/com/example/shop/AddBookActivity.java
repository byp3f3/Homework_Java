...
public class AddBookActivity extends AppCompatActivity {
    ...
    private static final int PICK_IMAGE_REQUEST = 1; // Request code for gallery selection
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(v -> {
            ...
            if (title.isEmpty() || priceStr.isEmpty() || id == -1 || selectedImageUri == null) {
                Toast.makeText(this, "Пожалуйста заполните все поляи выберите фотографию", Toast.LENGTH_SHORT).show();
                return;
            }
